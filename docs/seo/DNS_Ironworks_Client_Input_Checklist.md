# DNS Ironworks Client Input Checklist
...
- [ ] Provide only verified licenses, insurance, certifications, affiliations, warranties, financing, installation, delivery, and safety claims that may be published.
- [ ] Confirm years in business/experience and any approved maker/team biography facts.
- [ ] Select three to five completed projects suitable for case studies; provide location at the level allowed, scope, materials/process, outcome, photos, and publication permission.
- [ ] Provide real customer testimonials/reviews that may legally and ethically be reused, with permission where needed.
- [ ] Name known direct competitors in the actual service area.
...
- [ ] Approve the specific SEO Launch corrections before implementation: route-specific server metadata, real 404 responses, `/preview.html` handling, `/admin` indexing controls, preferred-host redirect, sitemap/canonical corrections, and measurement tags.
- [ ] Approve privacy/legal review for contact and visitor analytics disclosures; Mojave Marketing should not invent legal language.
- [ ] Approve the revised scope: all initial technical, Search Console/sitemap, GA4/conversion, GBP foundation, content-format, cart-count, and benchmark work belongs to SEO Launch; the first Local Essentials improvement starts with the priority service page.
